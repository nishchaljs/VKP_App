...
public class BaseURL {
    static final String APP_NAME = "VKP";
    public static final String PREFS_NAME = "VKPLoginPrefs";
    public static final String PREFS_NAME2 = "VKPLoginPrefs2";
...
//    public static final String KEY_NOTIFICATION_COUNT = "NOTIFICATION_COUNT";
    ...
    public static String BASE_URL = "http://xyzabc.com";
